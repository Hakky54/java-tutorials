...
- TODO - Spring Boot Server with Common Name Validation based on AOP with AspectJ Weaver

## Serialization & Deserialization ☢️
- TODO - Two way object serialization while using one model with Jackson and Spring Boot
